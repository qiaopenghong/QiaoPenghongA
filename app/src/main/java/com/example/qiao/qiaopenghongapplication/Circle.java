...
public class Circle extends View{
    ...
    public Circle(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(typedArray!=null){
            roundColor = typedArray.getColor(R.styleable.Circle_innerRoundColor, Color.GREEN);
            roundProgressColor = typedArray.getColor(R.styleable.Circle_roundProgressColor, Color.RED);
            innerRoundColor = typedArray.getColor(R.styleable.Circle_innerRoundColor, Color.GRAY);
            roundWidth = typedArray.getDimension(R.styleable.Circle_roundWidth, 5);
            textColor  =typedArray.getColor(R.styleable.Circle_textColor, Color.RED);
            textSize = typedArray.getDimension(R.styleable.Circle_textSize, 15);
            max = typedArray.getInteger(R.styleable.Circle_max, 100);
            style = typedArray.getInt(R.styleable.Circle_style, STROKE);
            isDisplayText  =typedArray.getBoolean(R.styleable.Circle_textIsDisplayable, true);
            typedArray.recycle();
        }
    }
